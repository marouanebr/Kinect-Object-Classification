...
//*************************************************************************
// strdef2.h
// change the type of PULSE and Int1[], CCount  from long to int
// becase windows 32,64bit and linux 32bit : long = 4byte
//        linux 64bit : long = 8byte
// sample program is designed that size of rtdata = 40byte.
// this is the case that long is 4 byte.

// sample.cpp
// for VC and Win32 app.(wsock32.lib)
// for VC++2008,use  ws2_32.lib and winsock2.h.
// If you want to use in Linux, please use sys/socket.h instead of winsock.h
//   and WSAStartup(), WSACleanup() is for Windows, closesocket() is alse windows,
//   for Linux, please use close().
